var isApprove=localStorage.getItem("isApprove");
$(function(){
		    	   ...
		    	   if(json.msg="success"){
		    		 if(!isnull(json.contentMag)){
		    			 ...
		    			 if(!isnull(contentMag.url)){
		    				 var url ='<p><span class="blue content_mag"><a href="javascript:;" ></a>下载附件</span></p>';  //href="'+contentMag.url+'"
		    			...
		    			$(".content_mag").click(function(){
		    			 ...
		    			 $(".Jog_Right_nocontent").html("");
		    			 $(".Jog_Right_nocontent").append("<p>暂无内容</p>"); 
		    	   ...
		    	   if(json.msg="success"){
		    		 if(!isnull(json.contentMag)){
		    			 ...
		    			 if(contentMag.isApprove == 1){
		    				 $(".Jog_Right_content").hide();
		    				 $(".Jog_Right_nocontent").html("");
			    			 $(".Jog_Right_nocontent").append("<p>此页面需要认证后才能访问，<span class='blue'>前往认证</span></p>"); 
		    				 $(".Jog_Right_nocontent").show(); 
		    			   }else{
		    					 $(".Jog_Right_content").show();
			    				 $(".Jog_Right_nocontent").hide();
